              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {EXPERT_PROFILES.map((ep) => {
                    ...
                    return (
                      <button key={ep.id} type="button" onClick={() => pickExpert(ep)} className="group relative text-left rounded-[14px] p-4 transition-all duration-200 cursor-pointer hover:-translate-y-0.5" style={on ? { background: "linear-gradient(135deg, rgba(160,125,56,0.14), rgba(160,125,56,0.05))", border: "1px solid rgba(160,125,56,0.55)", boxShadow: `0 0 0 3px rgba(160,125,56,0.12), ${T.shadow}` } : { background: T.card, border: `1px solid ${T.borderSoft}`, boxShadow: T.shadow }}>
