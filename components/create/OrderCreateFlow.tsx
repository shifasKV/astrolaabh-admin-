      ...
      <div className="grid grid-cols-1 lg:grid-cols-[210px_1fr_330px] gap-5 items-start pb-6">
        ...
        <div className="min-w-0">
          <Card className="!p-6">
            ...
            {step === 0 && (
              <div>
                ...
                {!customer ? (
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center gap-3 rounded-[12px] px-3.5 py-3" style={{ background: "linear-gradient(135deg, rgba(160,125,56,0.14), rgba(160,125,56,0.05))", border: "1px solid rgba(160,125,56,0.55)", boxShadow: "0 0 0 3px rgba(160,125,56,0.10)" }}>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {addresses.map((a, i) => {
                          ...
                          return (
                            <button key={i} onClick={() => setSelectedAddrIdx(i)} className="w-full flex items-start gap-2.5 text-left rounded-[10px] px-3.5 py-2.5 transition-colors" style={on ? { background: "linear-gradient(135deg, rgba(160,125,56,0.14), rgba(160,125,56,0.05))", border: "1px solid rgba(160,125,56,0.55)", boxShadow: "0 0 0 3px rgba(160,125,56,0.10)" } : { background: T.popover, border: `1px solid ${T.border}` }}>
            ...
            {/* STEP 2 — STONE — mirrors the Design step: gem chips, vault/custom toggle */}
            {step === 1 && (
              <div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  {ENERGISATION.map((e) => {
                    ...
                    return (
                      <button key={e.key} onClick={() => setEnergisationKey(e.key)} className="text-left rounded-[12px] px-4 py-3 cursor-pointer transition-all duration-150" style={active ? { background: "linear-gradient(135deg, rgba(160,125,56,0.14), rgba(160,125,56,0.05))", border: "1px solid rgba(160,125,56,0.55)", boxShadow: "0 0 0 3px rgba(160,125,56,0.10)" } : { background: T.popover, border: `1px solid ${T.borderSoft}` }}>
