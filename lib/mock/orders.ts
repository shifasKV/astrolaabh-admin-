...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    items: [{ sku: "AL-PKJ-0417", name: "Pukhraj · Ceylon Yellow Sapphire", qty: 1, price: 285000, gemstone: "Yellow Sapphire", caratWeight: "5.2r", itemType: "stone", itemStatus: "ready_to_ship", vendorName: "Sapphire Lanka Pvt.", vendorOrderId: "SL-2026-1104", receivedAt: "2026-02-18" }],
  ...
  },
  {
    ...
    items: [{ sku: "AL-MNK-0208", name: "Manik · Burmese Ruby", qty: 1, price: 412000, gemstone: "Ruby", caratWeight: "3.8r", itemType: "stone", itemStatus: "ready_to_ship", vendorName: "Myanmar Gems Co.", vendorOrderId: "MG-2026-0887", receivedAt: "2026-05-02" }],
  ...
  },
  {
    ...
    items: [{ sku: "AL-PNA-0312", name: "Panna · Colombian Emerald", qty: 1, price: 198000, gemstone: "Emerald", caratWeight: "4.1r", itemType: "stone", itemStatus: "order_received", vendorName: "Muzo Emeralds Int.", vendorOrderId: "ME-2026-0341", receivedAt: "2026-06-22" }],
  ...
  },
  {
    ...
    items: [
      { sku: "AL-NLM-0156", name: "Neelam · Sri Lankan Blue Sapphire", qty: 1, price: 520000, gemstone: "Blue Sapphire", caratWeight: "6.4r", itemType: "stone", itemStatus: "order_received", vendorName: "Sapphire Lanka Pvt.", vendorOrderId: "SL-2026-1298", receivedAt: "2026-07-25" },
      { sku: "DSN-VDYA-03", name: "Vidya Pendant · 18K Gold", qty: 1, price: 38000, itemType: "jewellery", itemStatus: "order_placed", vendorName: "Kanakadhara Jewellers", vendorOrderId: "KJ-2026-0567" },
    ],
  ...
  },
  {
    ...
    items: [
      { sku: "AL-MNK-0301", name: "Manik · Mozambique Ruby", qty: 1, price: 178000, gemstone: "Ruby", caratWeight: "2.9r", itemType: "stone", itemStatus: "order_received", vendorName: "GemRock Africa", vendorOrderId: "GR-2026-0201", receivedAt: "2026-06-08" },
      { sku: "DSN-AKSH-01", name: "Akshaya Ring · 22K Gold", qty: 1, price: 45000, itemType: "jewellery", itemStatus: "in_crafting", vendorName: "Kanakadhara Jewellers", vendorOrderId: "KJ-2026-0398", receivedAt: "2026-06-15" },
    ],
  ...
  },
  {
    ...
    items: [
      { sku: "AL-PKJ-0610", name: "Pukhraj · Thai Yellow Sapphire", qty: 1, price: 165000, gemstone: "Yellow Sapphire", caratWeight: "3.5r", itemType: "stone", itemStatus: "quality_check", vendorName: "Thai Gems House", vendorOrderId: "TG-2026-0712", receivedAt: "2026-07-01" },
      { sku: "DSN-SHRN-02", name: "Sharan Ring · 22K Gold", qty: 1, price: 52000, itemType: "jewellery", itemStatus: "quality_check", vendorName: "Kanakadhara Jewellers", vendorOrderId: "KJ-2026-0455", receivedAt: "2026-07-10" },
    ],
  ...
  },
  {
    ...
    items: [{ sku: "AL-NLM-0089", name: "Neelam · Kashmiri Blue Sapphire", qty: 1, price: 890000, gemstone: "Blue Sapphire", caratWeight: "8.1r", itemType: "stone", itemStatus: "ready_to_ship", vendorName: "Kashmir Sapphires", vendorOrderId: "KS-2026-0033", receivedAt: "2026-04-20" }],
  ...
  },
  {
    ...
    items: [{ sku: "AL-PNA-0445", name: "Panna · Zambian Emerald", qty: 1, price: 142000, gemstone: "Emerald", caratWeight: "3.2r", itemType: "stone", itemStatus: "ready_to_ship", vendorName: "Kagem Mining Ltd.", vendorOrderId: "KM-2026-0189", receivedAt: "2026-04-05" }],
  ...
  },
  {
    ...
    items: [
      { sku: "AL-MNG-0142", name: "Moonga · Italian Red Coral", qty: 1, price: 95000, gemstone: "Coral", caratWeight: "6.5r", itemType: "stone", itemStatus: "order_received", vendorName: "Torre del Greco Co.", vendorOrderId: "TG-2026-0088", receivedAt: "2026-08-01" },
      { sku: "DSN-LKSM-05", name: "Lakshmi Bracelet · 18K Rose Gold", qty: 1, price: 62000, itemType: "jewellery", itemStatus: "order_received", vendorName: "Kanakadhara Jewellers", vendorOrderId: "KJ-2026-0601", receivedAt: "2026-08-02" },
    ],
  ...
  },
  {
    ...
    items: [
      { sku: "AL-LSN-0033", name: "Lehsunia · Chrysoberyl Cat's Eye", qty: 1, price: 245000, gemstone: "Cat's Eye", caratWeight: "5.1r", itemType: "stone", itemStatus: "order_placed", vendorName: "Sri Lanka Gems Intl.", vendorOrderId: "SLG-2026-0221" },
      { sku: "DSN-DVYA-04", name: "Divya Ring · 22K Gold", qty: 1, price: 48000, itemType: "jewellery", itemStatus: "order_placed", vendorName: "Kanakadhara Jewellers", vendorOrderId: "KJ-2026-0710" },
    ],
  ...
  },
  {
    ...
    items: [{ sku: "AL-MTI-0155", name: "Moti · South Sea Pearl", qty: 1, price: 82000, gemstone: "Pearl", caratWeight: "5.8r", itemType: "stone", itemStatus: "in_transit", vendorName: "Australian Pearl Co.", vendorOrderId: "APC-2026-0112" }],
