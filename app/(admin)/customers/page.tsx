...
import { PageHeader, Card, StatCard, SearchFilter, GoldBtn, Chip, StatCardSkeleton, TableSkeleton, Pagination, ExportButton } from "@/components/ui";
    ...
    <>
      ...
      <div className="mb-4 flex items-center gap-2">
        <div className="flex-1 min-w-0">
          <SearchFilter search={search} onSearchChange={(v) => { setSearch(v); setPage(0); }} placeholder="Search name, email, phone, location…" />
        </div>
        <ExportButton data={exportData} filename="customers" className="ml-2 shrink-0" />
      </div>

      {loading ? (
        <>
          <div className="mb-6"><StatCardSkeleton count={5} /></div>
