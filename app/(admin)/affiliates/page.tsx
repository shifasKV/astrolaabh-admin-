          ...
          {sorted.length === 0 ? (
            ...
            sorted.map((a, idx) => {
              ...
              return (
                ...
                <Link
                  href={`/affiliates/${a.id}`}
                  className="group hidden md:grid md:grid-cols-[minmax(220px,1.3fr)_120px_70px_120px_110px_110px_130px_140px] gap-2 md:gap-x-4 items-center px-4 py-2.5 transition-colors duration-150 hover:!bg-[rgba(119,123,98,0.08)]"
